public class Homework4 {
	...
	/* 1 Return the product of the stored number and the
	...
	/* 2 Add the two provided numbers, and then multiply the
	...
	/* 3 Return the remainder of the first number divided by
	...
	/* 4 Return the length of the stored String
	 */
	...
	/* 5 Return the stored String followed by the provided
